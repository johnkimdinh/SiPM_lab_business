...
################################################################
#                        README                                #
# FRONTEND (GUI) script that collects data from the ammeter    #
################################################################
...
# Standalone script that controls picoammeter
import get_PIN_spectrum
...
# Still alive?
def hardware_test():
	get_PIN_spectrum.check_communication_Pico_Ammeter()
	print ("="*50)
...
# Initialization GUI
root = Tk()
root.title("PIN Diode Data Collection Routine")
